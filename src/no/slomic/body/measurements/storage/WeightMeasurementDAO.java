...
public class WeightMeasurementDAO {
    ...
    public Measurement create(Measurement newMeasurement) {
        ...
        values.put(WeightMeasurementTable.COLUMN_UNIT_SYMBOL, newMeasurement.getQuantity()
                .getUnit().getSymbol());
        values.put(WeightMeasurementTable.COLUMN_CREATED_DATE, Calendar.getInstance()
                .getTimeInMillis());

        database.insert(WeightMeasurementTable.TABLE_NAME, null, values);
        Cursor cursor = database
                .query(WeightMeasurementTable.TABLE_NAME, allColumns,
                        WeightMeasurementTable.COLUMN_MEASUREMENT_DATE + " = '"
    ...
    public void delete(Measurement measurement) {
        ...
        Log.d(SQLiteHelper.class.getName(), "Deleted Weight Measurement " + measurement);
    }
    ...
    public List<Measurement> getAll() {
        ...
        Cursor cursor = database.query(WeightMeasurementTable.TABLE_NAME, allColumns, null, null,
        ...
        Log.d(SQLiteHelper.class.getName(), "Getting all Weight Measurements. List size: "
                + measurements.size());
        return measurements;
    }
    ...
    public TreeSet<Measurement> getAllLastWeek() {
        ...
        String selection = WeightMeasurementTable.COLUMN_MEASUREMENT_DATE + " >= "
                ...
                + WeightMeasurementTable.COLUMN_MEASUREMENT_DATE + " <= " + today.getTimeInMillis()
                + " ";
        ...
        Cursor cursor = database.query(WeightMeasurementTable.TABLE_NAME, allColumns, selection,
    ...
    public Measurement getLatest() {
        ...
        if (cursor.moveToFirst()) {
            ...
            Log.d(SQLiteHelper.class.getName(), "Retrieved latest Weight Measurements. [Date:"
                    + measurement.getDate().toString() + ", quantity: "
                    + measurement.getQuantity().toString());
        } else
            Log.d(SQLiteHelper.class.getName(), "No latest weight measurement found.");
