...
public class HeightMeasurementDAO {
	...
	private String[] allColumns = {
			...
			HeightMeasurementTable.COLUMN_UNIT_SYMBOL,
			HeightMeasurementTable.COLUMN_CREATED_DATE };
	...
	public Measurement create(Measurement newMeasurement) {
		...
		values.put(HeightMeasurementTable.COLUMN_QUANTITY_VALUE, newMeasurement
				.getQuantity().getValue());
		values.put(HeightMeasurementTable.COLUMN_MEASUREMENT_DATE, l);
		values.put(HeightMeasurementTable.COLUMN_UNIT_SYMBOL, newMeasurement
				.getQuantity().getUnit().getSymbol());
		values.put(HeightMeasurementTable.COLUMN_CREATED_DATE, Calendar
				.getInstance().getTimeInMillis());

		database.insert(HeightMeasurementTable.TABLE_NAME, null, values);
		Cursor cursor = database.query(HeightMeasurementTable.TABLE_NAME,
				allColumns, HeightMeasurementTable.COLUMN_MEASUREMENT_DATE
	...
	public void delete(Measurement measurement) {
		...
		Log.d(SQLiteHelper.class.getName(), "Deleted Height Measurement "
				+ measurement);
	}
	...
	public List<Measurement> getAll() {
		...
		Cursor cursor = database.query(HeightMeasurementTable.TABLE_NAME,
				...
				HeightMeasurementTable.COLUMN_MEASUREMENT_DATE + " ASC");
		...
		Log.d(SQLiteHelper.class.getName(),
				"Getting all Height Measurements. List size: "
						+ measurements.size());
		return measurements;
	}
	...
	public Measurement getLatest() {
		...
		if (cursor.moveToFirst()) {
			...
			Log.d(SQLiteHelper.class.getName(),
					"Retrieved latest Height Measurements. [Date:"
							+ measurement.getDate().toString() + ", quantity: "
							+ measurement.getQuantity().toString());
		} else
			Log.d(SQLiteHelper.class.getName(),
					"No latest Height measurement found.");
