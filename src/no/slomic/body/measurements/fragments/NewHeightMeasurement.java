...
OnDateSetListener, OnQuantitySetListener 
{
	...
	// TODO: når skjermen snues horisontalt kalles denne metoden på nytt, noe som nullstiller eksisterende valg i vinduet
	@Override
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		// TODO: omstrukturer koden under slik det er gjord i QuantityWeightPicker
						...
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog,
								...
								Toast.makeText(getActivity(),
										"Measurement added", Toast.LENGTH_SHORT)
										.show();
							}
						})
	...
	// TODO: vurder å rename metoden under og flytte deler av onCreateDialog over hit
