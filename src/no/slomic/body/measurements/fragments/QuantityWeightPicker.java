...
public class QuantityWeightPicker extends DialogFragment implements DialogInterface.OnClickListener {
	...
	public QuantityWeightPicker(OnQuantitySetListener listener,
	...
	// TODO: når skjermen snues horisontalt kalles denne metoden på nytt, noe som fører til nullpointexception da tom construktør kalles
	@Override
	public Dialog onCreateDialog(Bundle savedInstanceState) 
	{
		...
		wholeNumbersPicker.
		setValue(DecimalUtils.getWholePartOfValue(quantity.getValue()));
