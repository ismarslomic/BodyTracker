...
public class QuantityStringFormat {
     ...
     *         decimal is returned (i.e. 75.5 kg). If between 1 and 10 kg then
     *         two decimals are returned (i.e. 5.65 kg). If value < 1 kg then
     *         only gram is returned (i.e. 100 g or 50 g). If the quantity is
     *         empty or not valid empty string will be returned
     */
     ...
     * 
     * @param q the quantity of weight to format the string
     * @return formatted string of quantity value. If value > 10 kg then pounds
     *         (in plural form) and ounces with zero decimals is returned. If
     *         between 0,45 kg (1 pound) and 10 kg then pounds (in plural form
     *         if > 1) with zero decimal and ounces with one decimal is
     *         returned. If value < 0,45 (1 pound) kg then only ounces with one
     *         decimal is returned. If the quantity is empty or not valid empty
