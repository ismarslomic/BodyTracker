...
public class DateUtils 
{
	...
	public final static SimpleDateFormat MEDIUM_DATE_FORMAT = new SimpleDateFormat("EEEE d. MMMMM yyyy");
	public final static SimpleDateFormat MEDIUM_DATE_FORMAT_EX_YEAR = new SimpleDateFormat("EEEE d. MMMMM");
	
	public final static SimpleDateFormat LONG_DATE_FORMAT = new SimpleDateFormat("dd.MM.yyyy HH:mm:ss");
	
	/**
	 * @param date String date in format dd.MM.yyyy
	 * @return Calendar date representing date sent as input. Returns null if invalid date string
	 */
